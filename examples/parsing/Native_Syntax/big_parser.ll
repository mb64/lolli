...
%  yes
%
%  ?- parse "who wondered which book josh wrote" T.
%
%  T_180512 <- quest (npwh (nwh who) Gap_193502) (vp (qv wondered) 
%             (qbar (npwh which (optap epsilon) (n book) Gap_209985) 
%             (sent (np (pnposs (pn josh))) (vp (tv wrote) (np Gap_209985))))).
%  yes
%
...
quest P1 P2 (quest (NPWH Gap) Q) :- npwh P1 PA NPWH, 
     	(forall P\ np P P (np Gap)) -o quest PA P2 Q.
quest P1 P2 (quest (APW Gap) Q) :- apwh P1 PA APW, 
     	(forall P\ ap P P (ap Gap)) -o quest PA P2 Q.
quest P1 P2 (quest (PPW Gap) Q) :- ppwh P1 PA PPW, 
     	(forall P\ pp P P (pp Gap)) -o quest PA P2 Q.
...
qbar P1 P2 (qbar (NPWH Gap) S) :- npwh P1 PA NPWH, 
     	(forall P\ np P P (np Gap)) -o sent PA P2 S.
...
rel (that::P1) P2 (rel (that Gap) S) :- 
     	{(forall P\ np P P (np Gap)) -o sent P1 P2 S}.
rel (whom::P1) P2 (rel (whom Gap) S) :- 
	{(forall P\ np P P (np Gap)) -o sent P1 P2 S}.
rel P1 P2 (rel P (whom Gap) S) :- 
	p P1 (whom::PA) P,
	{(forall P\ pp P P (pp Gap)) -o sent PA P2 S}.
